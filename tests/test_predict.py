...
def test_predict_bad_type():
    ...
    r = client.post("/predict", json={"sepal_length": "oops", "sepal_width": 3.5, "petal_length": 1.4, "petal_width": 0.2})
    assert r.status_code == 422

def test_predict_extra_field_current_behaviour():
    #pydantic ignores extra fields by default
    r = client.post("/predict", json={"sepal_length": 5.1, "sepal_width": 3.5, "petal_length": 1.4, "petal_width": 0.2, "extra": 1})
